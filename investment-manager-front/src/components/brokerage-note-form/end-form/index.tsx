    ...
    return <Box>
                ...
                <Grid container spacing={2}>
                    <Grid item xs={12} sm={6} lg={3}>
                        <TextField type="date" sx={{display: 'flex'}} {...register('financialSummary.netDate')} InputLabelProps={{shrink: true}} id="outlined-basic" label="Líquido para" variant="outlined" />
                    </Grid>
                    <Grid item xs={12} sm={6} lg={3}>
                        <TextField sx={{display: 'flex'}} {...register('financialSummary.netTotalValue', {valueAsNumber: true})} InputLabelProps={{shrink: true}} id="outlined-basic" label="Valor total" variant="outlined" />
                    </Grid>
                    <Grid item xs={12} sm={6} lg={3}>
